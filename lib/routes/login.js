...
// bluebird.coroutine is catching an unhandled exception from somewhere but
// then-yield is behaving as we expect. If we try to use bluebird-co then
// tests will fail but show as successful due to bluebird's internal universal
// handler
