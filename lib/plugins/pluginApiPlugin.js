...
function registerAttributesResolver (resolver) {
  this.jscasPlugins.attributesResolver = resolver
}
...
module.exports = fp(function pluginApiPlugin (instance, opts, next) {
  ...
  instance.decorate('registerAttributesResolver', registerAttributesResolver)
